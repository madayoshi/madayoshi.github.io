...
var SV_PATCH = {
    ...
    Salamence: { otherFormes: ['Salamence-Allira'] },
    Magearna: { otherFormes: ['Magearna-Allira'] },
    Gothitelle: { otherFormes: ['Gothitelle-Allira'] },
    'Aegislash-Shield': { otherFormes: ['Aegislash-Allira-Hunter'] },
    'Aegislash-Blade': { otherFormes: ['Aegislash-Allira-Trapper'] },
    Typhlosion: { otherFormes: ['Typhlosion-Allira'] },
    Zacian: { bs: { at: 120 } },
    ...
    'Gothitelle-Allira': {
        types: ['Psychic', 'Dark'],
        bs: { hp: 70, at: 50, df: 110, sa: 105, sd: 100, sp: 50 },
        weightkg: 50,
        abilities: { 0: 'Competitive' },
    ...
    Pallaidon: {
        types: ['Water', 'Steel'],
        bs: { hp: 70, at: 95, df: 80, sa: 90, sd: 60, sp: 128 },
        weightkg: 125,
        abilities: { 0: 'Oblivious' }
    },
    Corotrek: {
        types: ['Ice', 'Fighting'],
        bs: { hp: 80, at: 100, df: 80, sa: 90, sd: 70, sp: 105 },
        weightkg: 60,
        abilities: { 0: 'Hustle' }
    },
    'Typhlosion-Allira': {
        types: ['Fire', 'Steel'],
        bs: { hp: 100, at: 104, df: 90, sa: 60, sd: 110, sp: 70 },
        weightkg: 89,
        abilities: { 0: 'Blaze' },
        baseSpecies: 'Typhlosion'
    },
    Palmbol: {
        types: ['Psychic', 'Dark'],
        bs: { hp: 67, at: 60, df: 75, sa: 100, sd: 85, sp: 70 },
        weightkg: 27,
        abilities: { 0: 'Synchronize' }
    },
    Veltrilokist: {
    ...
    'Salamence-Allira': {
        types: ['Ground', 'Steel'],
        bs: { hp: 105, at: 125, df: 125, sa: 85, sd: 95, sp: 65 },
        weightkg: 925,
        abilities: { 0: 'Steelworker' },
        baseSpecies: 'Salamence'
    },
    ...
    Soilynx: {
        types: ['Ground'],
        bs: { hp: 85, at: 90, df: 110, sa: 50, sd: 100, sp: 80 },
        weightkg: 18.8,
        abilities: { 0: 'Sand Stream' }
    },
    'Weaving Wonder': {
        types: ['Dark', 'Poison'],
        bs: { hp: 101, at: 117, df: 67, sa: 73, sd: 127, sp: 85 },
        weightkg: 163,
        abilities: { 0: 'Protosynthesis' }
    },
    Cactarimba: {
        types: ['Grass', 'Fairy'],
        bs: { hp: 85, at: 91, df: 107, sa: 125, sd: 107, sp: 20 },
        weightkg: 112,
        abilities: { 0: 'Unaware' }
    },
    Zeblim: {
        types: ['Steel', 'Flying'],
        bs: { hp: 130, at: 90, df: 114, sa: 90, sd: 64, sp: 60 },
        weightkg: 400,
        abilities: { 0: 'Aftermath' }
    },
    Zermite: {
        types: ['Bug', 'Psychic'],
        bs: { hp: 71, at: 75, df: 62, sa: 82, sd: 88, sp: 82 },
        weightkg: 11,
        abilities: { 0: 'Swarm' }
    },
    Tabucat: {
        types: ['Dark', 'Normal'],
        bs: { hp: 89, at: 102, df: 72, sa: 103, sd: 88, sp: 86 },
        weightkg: 10.4,
        abilities: { 0: 'Soundproof' }
    },
    Coopoch: {
    ...
    Torrentoise: {
        types: ['Steel', 'Water'],
        bs: { hp: 100, at: 80, df: 125, sa: 100, sd: 110, sp: 20 },
        weightkg: 447.7,
        abilities: { 0: 'Drizzle' }
    },
    'Magearna-Allira': {
    ...
    Ceramimik: {
        types: ['Ghost', 'Ground'],
        bs: { hp: 75, at: 85, df: 120, sa: 125, sd: 100, sp: 35 },
        weightkg: 37.6,
        abilities: { 0: 'Clear Body' }
    },
    Crystalier: {
        types: ['Ice', 'Rock'],
        bs: { hp: 90, at: 70, df: 130, sa: 70, sd: 130, sp: 30 },
        weightkg: 4,
        abilities: { 0: 'Dauntless Shield' }
    },
    Solzilla: {
        types: ['Psychic', 'Dragon'],
        bs: { hp: 105, at: 70, df: 70, sa: 120, sd: 90, sp: 70 },
        weightkg: 1,
        abilities: { 0: 'Regenerator' }
    },
    'Pyukumuku-Allira': {
        types: ['Poison', 'Fairy'],
        bs: { hp: 75, at: 30, df: 95, sa: 110, sd: 95, sp: 5 },
        weightkg: 1.2,
        abilities: { 0: 'Storm Drain' },
    ...
    Bonner: {
        types: ['Dragon', 'Fairy'],
        bs: { hp: 125, at: 83, df: 91, sa: 107, sd: 101, sp: 63 },
        weightkg: 21,
        abilities: { 0: 'Effect Spore' }
    },
    Tamvlod: {
        types: ['Fire', 'Fairy'],
        bs: { hp: 90, at: 50, df: 80, sa: 120, sd: 110, sp: 65 },
        weightkg: 85,
        abilities: { 0: 'Heat Proof' }
    },
    Modernno: {
        types: ['Normal', 'Ghost'],
        bs: { hp: 70, at: 110, df: 85, sa: 65, sd: 65, sp: 105 },
        weightkg: 0.5,
        abilities: { 0: 'Aerilate' }
    },
    Vedgehog: {
        types: ['Normal', 'Ground'],
        bs: { hp: 110, at: 85, df: 75, sa: 60, sd: 90, sp: 50 },
        weightkg: 45,
        abilities: { 0: 'Rough Skin' }
    },
    Oriastal: {
        types: ['Steel', 'Dragon'],
        bs: { hp: 82, at: 111, df: 118, sa: 63, sd: 104, sp: 62 },
        weightkg: 172.6,
        abilities: { 0: 'Heavy Metal' }
    },
    Geishard: {
        types: ['Ghost', 'Steel'],
        bs: { hp: 50, at: 85, df: 70, sa: 85, sd: 70, sp: 115 },
        weightkg: 0.1,
        abilities: { 0: 'Iron Barbs' }
    },
    'Aegislash-Allira-Hunter': {
        types: ['Grass', 'Water'],
        bs: { hp: 60, at: 55, df: 120, sa: 55, sd: 120, sp: 90 },
        weightkg: 64,
        abilities: { 0: 'Stance Change' },
        otherFormes: ['Aegislash-Allira-Trapper'],
        baseSpecies: 'Aegislash-Shield'
    },
    'Aegislash-Allira-Trapper': {
        types: ['Grass', 'Water'],
        bs: { hp: 60, at: 130, df: 60, sa: 110, sd: 60, sp: 80 },
        weightkg: 64,
        abilities: { 0: 'Stance Change' },
    ...
    Dracokade: {
        types: ['Bug', 'Dragon'],
        bs: { hp: 120, at: 120, df: 120, sa: 30, sd: 90, sp: 30 },
        weightkg: 230,
        abilities: { 0: 'Merciless' }
    },
    Rollision: {
        types: ['Steel', 'Fighting'],
        bs: { hp: 110, at: 96, df: 135, sa: 64, sd: 42, sp: 34 },
        weightkg: 450,
        abilities: { 0: 'Iron Barbs' }
    },
    Acrolaos: {
        types: ['Fighting', 'Bug'],
        bs: { hp: 85, at: 95, df: 90, sa: 60, sd: 70, sp: 50 },
        weightkg: 43,
        abilities: { 0: 'Battle Armor' }
    },
    Titanoso: {
        types: ['Ground', 'Fairy'],
        bs: { hp: 132, at: 102, df: 84, sa: 102, sd: 84, sp: 96 },
        weightkg: 360,
        abilities: { 0: 'Inner Focus' }
    },
    Arcanchant: {
        types: ['Fairy', 'Flying'],
        bs: { hp: 110, at: 100, df: 60, sa: 75, sd: 85, sp: 95 },
        weightkg: 77,
        abilities: { 0: 'Gale Wings' }
    },
    Electrocampus: {
        types: ['Water', 'Electric'],
        bs: { hp: 100, at: 75, df: 105, sa: 75, sd: 105, sp: 50 },
        weightkg: 17,
        abilities: { 0: 'Poison Heal' }
    },
    Amphiry: {
        types: ['Poison', 'Dark'],
        bs: { hp: 80, at: 115, df: 72, sa: 80, sd: 70, sp: 113 },
        weightkg: 1.3,
        abilities: { 0: 'Poison Point' }
    },
    Lediary: {
    ...
    Chemiclysm: {
        types: ['Grass', 'Steel'],
        bs: { hp: 36, at: 123, df: 95, sa: 107, sd: 95, sp: 114 },
        weightkg: 120.9,
        abilities: { 0: 'Emergency Exit' }
    },
    Scorsmith: {
        types: ['Fire', 'Fighting'],
        bs: { hp: 120, at: 120, df: 85, sa: 55, sd: 85, sp: 55 },
        weightkg: 150,
        abilities: { 0: 'Heavy Metal' }
    },
    Salackle: {
        types: ['Poison', 'Fire'],
        bs: { hp: 117, at: 111, df: 60, sa: 64, sd: 60, sp: 68 },
        weightkg: 20.8,
        abilities: { 0: 'Shed Skin' }
    },
    'Musharna-Allira': {
        types: ['Water', 'Flying'],
        bs: { hp: 116, at: 35, df: 95, sa: 117, sd: 106, sp: 19 },
        weightkg: 30.1,
        abilities: { 0: 'Natural Cure' }
    },
    Barbarado: {
        types: ['Grass', 'Ground'],
        bs: { hp: 115, at: 112, df: 80, sa: 73, sd: 80, sp: 70 },
        weightkg: 204,
        abilities: { 0: 'Overgrow' }
    },
    Magpillage: {
        types: ['Fire', 'Flying'],
        bs: { hp: 80, at: 72, df: 95, sa: 108, sd: 80, sp: 85 },
        weightkg: 10.2,
        abilities: { 0: 'Blaze' }
    },
    Shrimpact: {
        types: ['Water', 'Fighting'],
        bs: { hp: 108, at: 65, df: 100, sa: 115, sd: 82, sp: 60 },
        weightkg: 56,
        abilities: { 0: 'Torrent' }
    },
    Hopobops: {
        types: ['Normal', 'Fighting'],
        bs: { hp: 70, at: 89, df: 70, sa: 50, sd: 70, sp: 101 },
        weightkg: 3,
        abilities: { 0: 'Iron Fist' }
    },
    Motheorie: {
        types: ['Bug', 'Fairy'],
        bs: { hp: 100, at: 80, df: 95, sa: 115, sd: 115, sp: 65 },
        weightkg: 255.8,
        abilities: { 0: 'Sphinx\'s Riddle' }
    },
    Cardtridge: {
        types: ['Flying', 'Ground'],
        bs: { hp: 75, at: 110, df: 80, sa: 95, sd: 65, sp: 55 },
        weightkg: 13,
        abilities: { 0: 'Super Luck' }
    },
    Scarva: {
        types: ['Bug', 'Dragon'],
        bs: { hp: 70, at: 35, df: 90, sa: 40, sd: 80, sp: 30 },
        weightkg: 1.2,
        nfe: true,
        abilities: { 0: 'Poison Heal' }
    },
    Gentloo: {
        types: ['Ice', 'Fighting'],
        bs: { hp: 50, at: 85, df: 42, sa: 44, sd: 40, sp: 61 },
        weightkg: 10,
        nfe: true,
        abilities: { 0: 'Hustle' }
    },
    Pupuppa: {
        types: ['Bug', 'Ghost'],
        bs: { hp: 60, at: 40, df: 60, sa: 60, sd: 80, sp: 35 },
        weightkg: 12.4,
        nfe: true,
        abilities: { 0: 'Limber' }
    },
    'Bagon-Allira': {
        types: ['Ground'],
        bs: { hp: 60, at: 70, df: 30, sa: 30, sd: 30, sp: 80 },
        weightkg: 35,
        nfe: true,
        abilities: { 0: 'Guts' },
        baseSpecies: 'Bagon'
    ...
    'Shelgon-Allira': {
        types: ['Ground', 'Steel'],
        bs: { hp: 70, at: 90, df: 110, sa: 60, sd: 75, sp: 15 },
        weightkg: 230,
        nfe: true,
        abilities: { 0: 'Guts' },
        baseSpecies: 'Shelgon'
    ...
    Kitsilt: {
        types: ['Ground'],
        bs: { hp: 45, at: 40, df: 50, sa: 30, sd: 45, sp: 40 },
        weightkg: 9.6,
        nfe: true,
        abilities: { 0: 'Pickup' }
    },
    'Drifblim-Allira': {
        types: ['Steel', 'Flying'],
        bs: { hp: 130, at: 80, df: 84, sa: 80, sd: 54, sp: 80 },
        weightkg: 20,
        nfe: true,
        abilities: { 0: 'Aftermath' },
    ...
    Clockoo: {
        types: ['Steel'],
        bs: { hp: 102, at: 55, df: 80, sa: 40, sd: 75, sp: 38 },
        weightkg: 235,
        nfe: true,
        abilities: { 0: 'Heavy Metal' }
    },
    Maceor: {
        types: ['Steel', 'Bug'],
        bs: { hp: 57, at: 40, df: 76, sa: 10, sd: 20, sp: 15 },
        weightkg: 13,
        nfe: true,
        abilities: { 0: 'Iron Barbs' }
    },
    Smolangel: {
        types: ['Fairy', 'Flying'],
        bs: { hp: 65, at: 60, df: 30, sa: 45, sd: 45, sp: 55 },
        weightkg: 0.1,
        nfe: true,
        abilities: { 0: 'Hustle' }
    },
    Crustarid: {
        types: ['Water'],
        bs: { hp: 58, at: 65, df: 60, sa: 50, sd: 41, sp: 40 },
        weightkg: 12,
        nfe: true,
        abilities: { 0: 'Torrent' }
    },
    Pistroop: {
        types: ['Water'],
        bs: { hp: 93, at: 65, df: 95, sa: 65, sd: 71, sp: 35 },
        weightkg: 43,
        nfe: true,
        abilities: { 0: 'Torrent' }
    }
